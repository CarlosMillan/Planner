<%@ Page Language="C#" MasterPageFile="~/Planner.Master" AutoEventWireup="true" CodeBehind="StoppedOrders.aspx.cs" Inherits="PlannerWeb.StoppedOrders" %>
<asp:Content ID="ContentHead" ContentPlaceHolderID="head" runat="server">
    <!-- Css -->
    <link href="Css/Pages/StoppedOrders.css" rel="stylesheet" type="text/css" />
</asp:Content>
...
<asp:Content ID="ContentPagination" ContentPlaceHolderID="ContentPlaceHolderPagination" runat="server">
    <div class="headerTitle pages">1/4</div>
</asp:Content>
<asp:Content ID="ContentPageTile" ContentPlaceHolderID="ContentPlaceHolderPageTitle" runat="server">    
    <div class="headerTitle subtitle">ÓRDENES DETENIDAS 27</div>
</asp:Content>
